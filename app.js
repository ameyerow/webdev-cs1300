...
const updatePage = async () => {
  ...
  const highSugarFruits = fruitsArray.filter(fruit => fruit.nutritions.sugar > 15).map(fruit => fruit.name);
  console.log(highSugarFruits);

  // TODO: Create a new HTML element to display your data

  const newElement = document.createElement('div');
  newElement.innerHTML = "Fruits with sugar greater than 15: " + highSugarFruits;
